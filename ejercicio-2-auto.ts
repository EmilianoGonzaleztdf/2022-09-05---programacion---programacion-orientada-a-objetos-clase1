...
let auto2 = new auto("fiat","argo",2022,"rojo pasion",12346,true);
let auto3 = new auto("chevrolet","corsa",2008,"amarillo patito",12347,false);
let auto4 = new auto("renault","logan ii",2020,"verde manzana",12347,true);
let auto5 = new auto("ford","fiesta kinetic", 2015,"negro como la noche",12348,false);
